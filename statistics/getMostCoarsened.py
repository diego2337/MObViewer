...
# @desc Get most coarsened bipartite graph.
# @param {str} input .json input file name.
# @param {str} directory Directory to list files from.
def getMostCoarsened(input, directory):
    ...
    os.chdir(pwd)
    # Step 3 - Return most coarsened graph level
    return graphName + reductionFactor + "nl" + str(nl) + "nr" + str(nr) + ".json"
...
if __name__ == "__main__":
    ...
    print(getMostCoarsened(options.input, options.directory))
